...
struct VehicleGuardActionIntentEnable: AppIntent {
    ...
    @Parameter(
        ...
        default: getDefaultValue(targetType: TypeIntent.vehicle_guard),
...
struct VehicleStartActionIntent: AppIntent {
    ...
    @Parameter(
        title: "Устройство",
        description: "Выберите устройство для управления",
        default: getDefaultValue(targetType: TypeIntent.vehicle_start),
...
struct VehicleSirenActionIntentEnable: AppIntent {
    ...
    @Parameter(
        title: "Устройство",
        description: "Выберите устройство для управления",
        default: getDefaultValue(targetType: TypeIntent.vehicle_siren),
...
struct VehicleBlockActionIntentActive: AppIntent {
    ...
    @Parameter(
        title: "Устройство",
        description: "Выберите устройство для управления",
        default: getDefaultValue(targetType: TypeIntent.vehicle_block),
